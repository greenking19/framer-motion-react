...
const Believe = () => {
  ...
  return (
    <div className='h-[596px] bg-white relative'>
      ...
      <motion.div
        layout
        className='card1 box-borde h-[355px] absolute left-[368px] bg-[#EDE9FF] rounded-[5px] top-[170px] border border-current p-[20px] gap-[30px] flex'
        animate={active === 'card1' ? 'hover' : 'init'}
        variants={cardVariants}
        transition={{ duration: 0.6 }}
      >
        <div className="h-[315px] w-[330px] bg-blue-600 bg-center bg-cover bg-[url('../public/ivana.png')] index-1" />
        <motion.div
      ...
      {/* card 2 */}
      <motion.div
        className='top-[170px] left-[1025px] box-borde flex w-[330px] overflow-hidden h-[355px] absolute bg-[#E8FFA8] border border-current rounded-[5px] p-[20px] gap-[30px]'
      ...
      >
        <div className="h-[315px] bg-center w-[330px] bg-center bg-cover bg-[url('../public/surface-VDWS2oWdZzg.png')] index-1" />
        <motion.div
          variants={titleVariants}
          transition={{ duration: 0.6 }}
